...
export async function createPermanence(permanence) {
    await db.query(` 
    INSERT INTO permanence (children_id, guardian_entrance_id, entry_date, obs) 
    VALUES ($1, $2, $3, $4)
    `, [permanence.childrenId, permanence.guardianEntranceId, permanence.entry_date, permanence.obs]
    );
} 
